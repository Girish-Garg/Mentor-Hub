    ...
    >
      <div className="flex flex-col flex-1 min-w-0 gap-3">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <span className="text-gray-600 text-md flex items-center gap-1">by <span className="font-medium inline-block max-w-[150px] truncate overflow-hidden">{author}</span></span>
          {tags.length > 0 && (
