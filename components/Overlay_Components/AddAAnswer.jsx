...
import { PenLine  , CircleX, Maximize2, X } from "lucide-react";
...
export default function AddAnswer() {
  ...
  const isFormInvalid =  isMediaInvalid || isFilesInvalid;
  ...
  return (
    <div className="w-[69.74vw] mx-auto bg-white rounded-xl shadow-md px-[1.25vw]">
      <div className="flex justify-between items-center ">
        <div className="flex items-center gap-2 text-base mt-[2.222vh] mb-[2.222vh]  font-medium">
          <PenLine  className="w-4 h-4" />
          <span>Add a Answer</span>
        </div>

        <div className="flex items-center mt-[2.222vh] mb-[2.222vh] gap-[0.625vw]">
      ...
      <div className="mb-[1.481vh] relative">
        <input
          rows="1"
          placeholder="Question id #12231123 auto selected system generated How to kill a spirit which has multi dimensional powers like shape shifting or summoning stuff like sacred sw..."
disabled
          value={question}
      ...
      <div className="mb-[7vh]">
        <ReactQuill
          ...
          className="bg-white md:h-[35.463vh] md:mb-0 mb-2 h-[34.463vh] w-[67.24vw]  rounded-xl"
        />
      </div>
      <div className="fix mb-[1.481vh]  md:mt-0 ">
